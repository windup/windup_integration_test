...
class Application(object):
    def __init__(
        ...
        from rhamt.base.application.implementations import RhamtImplementationContext

        # TODO: include other context in future
        self.context = RhamtImplementationContext.from_instances([self.web_ui])
        #    [self.browser])
    ...
    def collections(self):
        from rhamt.base.modeling import EntityCollections

...
from . import RhamtImplementationContext
from rhamt.utils.log import logger


class RhamtBrowserPlugin(DefaultPlugin):
...
class RhamtBrowser(Browser):
    def __init__(self, selenium_webdriver, endpoint, extra_objects=None):
        ...
        super(RhamtBrowser, self).__init__(
            selenium_webdriver,
            plugin_class=RhamtBrowserPlugin,
            logger=logger,
...
class NavigatableMixin(object):
    ...
    @property
    def browser(self):
        return self.application.web_ui.widgetastic_browser
    ...
    def create_view(self, view_class, o=None, override=None):
        ...
        if override is not None:
            ...
            new_obj = o
        return self.application.web_ui.create_view(
...
class RhamtNavigateStep(NavigateStep):
    VIEW = None
...
class ViaWebUI(Implementation):
    ...
    register_method_for = RhamtImplementationContext.external_for
    ...
    def widgetastic_browser(self):
        ...
        wt = RhamtBrowser(selenium_webdriver, self)

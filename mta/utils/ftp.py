...
class FTPClientWrapper(FTPClient):
    """
    This class is for MTA remote file management with FTP.  This will help to easily download
    testing related files in a runtime environment.

    Args:
        entity_path: entity which you want to analyse like war , ear files
    ...
    Usage:
        .. code-block:: python
          ...
          fs.mkd("Applications")   # create new entity type

          fs = FileServer("mta/Applications")
    ...
    def __init__(self, entity_path=None, entrypoint=None, host=None, login=None, password=None):
        ...
        login = login or credentials[env.ftpserver.credentials]["username"]
        password = password or credentials[env.ftpserver.credentials]["password"]
